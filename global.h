...
public:
    ...
    const static int ANIMATION_WINDOW_SIZE_X = TOWER_SIZE_X*7*GRID_SIZE; //Width of the window is 7 times the size of the tower.
    const static int ANIMATION_WINDOW_SIZE_Y = TOWER_SIZE_Y*3*GRID_SIZE; //Height of the window is 3 times the height of the tower.
